...
@WebServlet(name = "d10.ServletDemo25", urlPatterns = "/demo25")
 ...
 */
        ...
        System.out.println("在服务器端使用getParameterNames方法接收表单参数");
        ...
        System.out.println("在服务器端使用getParameterMap方法接收表单参数");
